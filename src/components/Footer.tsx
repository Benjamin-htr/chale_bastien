    ...
    <footer className={css({ fontSize: "sm", lineHeight: "sm", color: "gray.600" })}>
      ...
      >
        <a
          ...
          target="_blank"
          className={css({ display: "flex", maxW: "fit", alignItems: "center", gap: "2" })}
          rel="noopener noreferrer"
        >
          <svg
            className={css({ h: "auto", w: "6" })}
            width="1280"
            height="1280"
        ...
        <a
          ...
          href="https://github.com/thomasKn/astro-shopify/"
          target="_blank"
          rel="noopener noreferrer"
        >
          <svg
            className={css({ h: "5", w: "5", color: "gray.500" })}
            width="14"
            height="14"
            viewBox="0 0 14 14"
            fill="none"
        ...
        <a
          ...
          target="_blank"
        >
          <svg className={css({ h: "auto", w: "5" })} viewBox="0 0 98.1 118">
            {/* <style type="text/css">
              .st0 {
                fill: #ff3e00;
              }
        ...
        >
          <svg className={css({ h: "5", w: "5" })} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 54 33">
